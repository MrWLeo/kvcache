...
def main(p4info_file_path, bmv2_file_path):
    ...
    s1 = p4runtime_lib.bmv2.Bmv2SwitchConnection(name='s2',address='127.0.0.1:50052',device_id=1,proto_dump_file='../logs/s2-p4runtime-requests.txt')
    s1.MasterArbitrationUpdate()

    #if (s1.MasterArbitrationUpdate() == None):
    #    print "S2 Fail to establish the connection"
